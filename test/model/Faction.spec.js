...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Faction();
  });
  ...
  describe('Faction', function() {
    it('should create an instance of Faction', function() {
      // uncomment below and update the code to test Faction
      //var instance = new SpaceTradersApi.Faction();
      //expect(instance).to.be.a(SpaceTradersApi.Faction);
    });
