...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ShipMount();
  });
  ...
  describe('ShipMount', function() {
    it('should create an instance of ShipMount', function() {
      // uncomment below and update the code to test ShipMount
      //var instance = new SpaceTradersApi.ShipMount();
      //expect(instance).to.be.a(SpaceTradersApi.ShipMount);
    });
