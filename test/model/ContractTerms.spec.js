...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ContractTerms();
  });
  ...
  describe('ContractTerms', function() {
    it('should create an instance of ContractTerms', function() {
      // uncomment below and update the code to test ContractTerms
      //var instance = new SpaceTradersApi.ContractTerms();
      //expect(instance).to.be.a(SpaceTradersApi.ContractTerms);
    });
