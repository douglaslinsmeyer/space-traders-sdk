...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ShipModule();
  });
  ...
  describe('ShipModule', function() {
    it('should create an instance of ShipModule', function() {
      // uncomment below and update the code to test ShipModule
      //var instance = new SpaceTradersApi.ShipModule();
      //expect(instance).to.be.a(SpaceTradersApi.ShipModule);
    });
