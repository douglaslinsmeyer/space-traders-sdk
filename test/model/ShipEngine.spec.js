...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ShipEngine();
  });
  ...
  describe('ShipEngine', function() {
    it('should create an instance of ShipEngine', function() {
      // uncomment below and update the code to test ShipEngine
      //var instance = new SpaceTradersApi.ShipEngine();
      //expect(instance).to.be.a(SpaceTradersApi.ShipEngine);
    });
