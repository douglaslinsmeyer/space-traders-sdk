...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ScannedWaypoint();
  });
  ...
  describe('ScannedWaypoint', function() {
    it('should create an instance of ScannedWaypoint', function() {
      // uncomment below and update the code to test ScannedWaypoint
      //var instance = new SpaceTradersApi.ScannedWaypoint();
      //expect(instance).to.be.a(SpaceTradersApi.ScannedWaypoint);
    });
