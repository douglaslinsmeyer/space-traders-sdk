...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.Waypoint();
  });
  ...
  describe('Waypoint', function() {
    it('should create an instance of Waypoint', function() {
      // uncomment below and update the code to test Waypoint
      //var instance = new SpaceTradersApi.Waypoint();
      //expect(instance).to.be.a(SpaceTradersApi.Waypoint);
    });
