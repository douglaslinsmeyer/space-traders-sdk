...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ScannedShip();
  });
  ...
  describe('ScannedShip', function() {
    it('should create an instance of ScannedShip', function() {
      // uncomment below and update the code to test ScannedShip
      //var instance = new SpaceTradersApi.ScannedShip();
      //expect(instance).to.be.a(SpaceTradersApi.ScannedShip);
    });
