...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ShipyardShip();
  });
  ...
  describe('ShipyardShip', function() {
    it('should create an instance of ShipyardShip', function() {
      // uncomment below and update the code to test ShipyardShip
      //var instance = new SpaceTradersApi.ShipyardShip();
      //expect(instance).to.be.a(SpaceTradersApi.ShipyardShip);
    });
