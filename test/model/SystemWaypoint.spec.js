...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.SystemWaypoint();
  });
  ...
  describe('SystemWaypoint', function() {
    it('should create an instance of SystemWaypoint', function() {
      // uncomment below and update the code to test SystemWaypoint
      //var instance = new SpaceTradersApi.SystemWaypoint();
      //expect(instance).to.be.a(SpaceTradersApi.SystemWaypoint);
    });
