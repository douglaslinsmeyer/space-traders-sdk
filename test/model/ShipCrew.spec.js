...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ShipCrew();
  });
  ...
  describe('ShipCrew', function() {
    it('should create an instance of ShipCrew', function() {
      // uncomment below and update the code to test ShipCrew
      //var instance = new SpaceTradersApi.ShipCrew();
      //expect(instance).to.be.a(SpaceTradersApi.ShipCrew);
    });
    ...
    it('should have the property morale (base name: "morale")', function() {
      // uncomment below and update the code to test the property morale
      //var instance = new SpaceTradersApi.ShipCrew();
      //expect(instance).to.be();
    });
