...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ShipNavRoute();
  });
  ...
  describe('ShipNavRoute', function() {
    it('should create an instance of ShipNavRoute', function() {
      // uncomment below and update the code to test ShipNavRoute
      //var instance = new SpaceTradersApi.ShipNavRoute();
      //expect(instance).to.be.a(SpaceTradersApi.ShipNavRoute);
    });
