...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpaceTradersApi.ShipCargo();
  });
  ...
  describe('ShipCargo', function() {
    it('should create an instance of ShipCargo', function() {
      // uncomment below and update the code to test ShipCargo
      //var instance = new SpaceTradersApi.ShipCargo();
      //expect(instance).to.be.a(SpaceTradersApi.ShipCargo);
    });
