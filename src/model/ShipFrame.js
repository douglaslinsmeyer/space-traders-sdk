...
class ShipFrame {
     ...
     * @alias module:model/ShipFrame
     * @param symbol {module:model/ShipFrame.SymbolEnum} 
     * @param name {String} 
     ...
     */
    constructor(symbol, name, description, moduleSlots, mountingPoints, fuelCapacity, requirements) { 
        
        ShipFrame.initialize(this, symbol, name, description, moduleSlots, mountingPoints, fuelCapacity, requirements);
    }
     ...
     */
    static initialize(obj, symbol, name, description, moduleSlots, mountingPoints, fuelCapacity, requirements) { 
        obj['symbol'] = symbol;
        obj['name'] = name;
     ...
     * @param {module:model/ShipFrame} obj Optional instance to populate.
     * @return {module:model/ShipFrame} The populated <code>ShipFrame</code> instance.
     */
...
ShipFrame.RequiredProperties = ["symbol", "name", "description", "moduleSlots", "mountingPoints", "fuelCapacity", "requirements"];

/**
 * @member {module:model/ShipFrame.SymbolEnum} symbol
 */
