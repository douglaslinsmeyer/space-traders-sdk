...
import ShipRefine200ResponseDataProducedInner from './ShipRefine200ResponseDataProducedInner';
...
class ShipRefine200ResponseData {
     ...
     * @param produced {Array.<module:model/ShipRefine200ResponseDataProducedInner>} 
     * @param consumed {Array.<module:model/ShipRefine200ResponseDataProducedInner>} 
     */
    constructor(cargo, cooldown, produced, consumed) { 
        
        ShipRefine200ResponseData.initialize(this, cargo, cooldown, produced, consumed);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('produced')) {
                obj['produced'] = ApiClient.convertToType(data['produced'], [ShipRefine200ResponseDataProducedInner]);
            }
            if (data.hasOwnProperty('consumed')) {
                obj['consumed'] = ApiClient.convertToType(data['consumed'], [ShipRefine200ResponseDataProducedInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['produced']) { // data not null
            ...
            for (const item of data['produced']) {
                ShipRefine200ResponseDataProducedInner.validateJSON(item);
            };
        }
...
ShipRefine200ResponseData.RequiredProperties = ["cargo", "cooldown", "produced", "consumed"];
...
/**
 * @member {Array.<module:model/ShipRefine200ResponseDataProducedInner>} produced
 */
ShipRefine200ResponseData.prototype['produced'] = undefined;

/**
 * @member {Array.<module:model/ShipRefine200ResponseDataProducedInner>} consumed
 */
