...
class Faction {
     ...
     * 
     * @alias module:model/Faction
     * @param symbol {String} 
     * @param name {String} 
     * @param description {String} 
     * @param headquarters {String} 
     * @param traits {Array.<module:model/FactionTrait>} 
     */
    constructor(symbol, name, description, headquarters, traits) { 
        
        Faction.initialize(this, symbol, name, description, headquarters, traits);
    }
     ...
     */
    static initialize(obj, symbol, name, description, headquarters, traits) { 
        obj['symbol'] = symbol;
        obj['name'] = name;
     ...
     * @param {module:model/Faction} obj Optional instance to populate.
     * @return {module:model/Faction} The populated <code>Faction</code> instance.
     */
...
Faction.RequiredProperties = ["symbol", "name", "description", "headquarters", "traits"];
...
/**
 * @member {Array.<module:model/FactionTrait>} traits
 */
