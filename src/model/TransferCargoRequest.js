...
class TransferCargoRequest {
     ...
     * @param {module:model/TransferCargoRequest} obj Optional instance to populate.
     * @return {module:model/TransferCargoRequest} The populated <code>TransferCargoRequest</code> instance.
     */
