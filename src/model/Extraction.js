...
class Extraction {
     ...
     * @param _yield {module:model/ExtractionYield} 
     */
    constructor(shipSymbol, _yield) { 
        
        Extraction.initialize(this, shipSymbol, _yield);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('yield')) {
                obj['yield'] = ExtractionYield.constructFromObject(data['yield']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Extraction.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['yield']) { // data not null
          ExtractionYield.validateJSON(data['yield']);
        }
...
Extraction.RequiredProperties = ["shipSymbol", "yield"];

/**
 * @member {String} shipSymbol
 */
Extraction.prototype['shipSymbol'] = undefined;

/**
 * @member {module:model/ExtractionYield} yield
 */
Extraction.prototype['yield'] = undefined;
