 ...
 * @module model/JumpShipRequest
 * @version 2.0.0
 */
class JumpShipRequest {
    /**
     * Constructs a new <code>JumpShipRequest</code>.
     * @alias module:model/JumpShipRequest
     * @param systemSymbol {String} The system symbol to jump to.
     */
    constructor(systemSymbol) { 
        
        JumpShipRequest.initialize(this, systemSymbol);
    }
     ...
     */
    static initialize(obj, systemSymbol) { 
     ...
     * @param {module:model/JumpShipRequest} obj Optional instance to populate.
     * @return {module:model/JumpShipRequest} The populated <code>JumpShipRequest</code> instance.
     */
...
JumpShipRequest.RequiredProperties = ["systemSymbol"];

/**
 * The system symbol to jump to.
 * @member {String} systemSymbol
 */
JumpShipRequest.prototype['systemSymbol'] = undefined;
