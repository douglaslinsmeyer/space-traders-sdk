...
class ShipNavRoute {
     ...
     * @alias module:model/ShipNavRoute
     * @param destination {module:model/ShipNavRouteWaypoint} 
     * @param departure {module:model/ShipNavRouteWaypoint} 
     ...
     */
    constructor(destination, departure, departureTime, arrival) { 
        
        ShipNavRoute.initialize(this, destination, departure, departureTime, arrival);
    }
     ...
     */
    static initialize(obj, destination, departure, departureTime, arrival) { 
     ...
     * @param {module:model/ShipNavRoute} obj Optional instance to populate.
     * @return {module:model/ShipNavRoute} The populated <code>ShipNavRoute</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('departure')) {
                obj['departure'] = ShipNavRouteWaypoint.constructFromObject(data['departure']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['departure']) { // data not null
          ShipNavRouteWaypoint.validateJSON(data['departure']);
        }
...
ShipNavRoute.RequiredProperties = ["destination", "departure", "departureTime", "arrival"];

/**
 * @member {module:model/ShipNavRouteWaypoint} destination
 */
ShipNavRoute.prototype['destination'] = undefined;

/**
 * @member {module:model/ShipNavRouteWaypoint} departure
 */
ShipNavRoute.prototype['departure'] = undefined;
